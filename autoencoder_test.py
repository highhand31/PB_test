...
class AE():
    ...
    def data_init(self):
        ...
        (self.x_train, self.x_train_label, no1, no2) = cm.data_load(pic_path, train_ratio=1, resize=(width, height), \
                                                          has_dir=False)
...
ae = AE()
# ae.train(x_train,x_test_2,x_test_label_2,epochs = 1)